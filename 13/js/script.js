...
/* harmony import */ var _showPrize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./showPrize */ "./source/js/modules/showPrize.js");
...
class FullPageScroll {
  ...
  changePageDisplay() {
    ...
    if (this.screenElements[this.activeScreen].id === `prizes` && !this.prizesSeen) {
      ...
      Object(_showPrize__WEBPACK_IMPORTED_MODULE_2__["default"])({
    ...
    if (this.screenElements[this.activeScreen].id === `game`) {
      Object(_game_timer__WEBPACK_IMPORTED_MODULE_1__["default"])(5 * 60 * 1000, document.querySelector(`.game__counter`));
    }
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ((wholeTime, timerElement) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _runSvgAnimation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./runSvgAnimation */ "./source/js/modules/runSvgAnimation.js");
    ...
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        setTimeout(() => {
          ...
          Object(_runSvgAnimation__WEBPACK_IMPORTED_MODULE_0__["default"])(targetEl[0].querySelector(`.result__title object`), 1);
        }, 100);
      });
    }
...
/***/ "./source/js/modules/runSvgAnimation.js":
/*!**********************************************!*\
  !*** ./source/js/modules/runSvgAnimation.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ((svgObject, delay) => {
  const runAnimaion = (svgContent) => {
    const startAnimation = svgContent.getElementById(`start`);
    if (startAnimation) {
      setTimeout(() => {
...
/***/ "./source/js/modules/showPrize.js":
/*!****************************************!*\
  !*** ./source/js/modules/showPrize.js ***!
  \****************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _runSvgAnimation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./runSvgAnimation */ "./source/js/modules/runSvgAnimation.js");
/* harmony import */ var _text_changer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./text-changer */ "./source/js/modules/text-changer.js");
...
/* harmony default export */ __webpack_exports__["default"] = (({
  ...
  if (typeof finalNumber === `number`) {
    ...
    setTimeout(() => {
      Object(_text_changer__WEBPACK_IMPORTED_MODULE_1__["default"])(
          numberElement,
          array,
          12
      ).then(() => {
  ...
  Object(_runSvgAnimation__WEBPACK_IMPORTED_MODULE_0__["default"])(svgElement, delayForSvg);
});
...
/***/ "./source/js/modules/text-changer.js":
/*!*******************************************!*\
  !*** ./source/js/modules/text-changer.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ((element, textArray, fps) => {
...
/* harmony import */ var _modules_letter_animation_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/letter-animation.js */ "./source/js/modules/letter-animation.js");
// modules
...
Object(_modules_letter_animation_js__WEBPACK_IMPORTED_MODULE_10__["default"])();
